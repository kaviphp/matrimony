<div class="card">
    <div class="card-header">
        <h5 class="mb-0 h6">{{translate('Islam Education Info')}}</h5>
        <div class="text-right">
            <a onclick="islam_education_add_modal('{{$member->id}}');"  href="javascript:void(0);" class="btn btn-sm btn-primary ">
    ...
    <div class="card-body">
        <table class="table aiz-table">
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="javascript:void(0);" class="btn btn-soft-info btn-icon btn-circle btn-sm" onclick="islam_education_edit_modal('{{$education->id}}');" title="{{ translate('Edit') }}">
