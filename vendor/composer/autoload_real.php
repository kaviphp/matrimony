...
class ComposerAutoloaderInit7ec6d28e7a5b31abe58f7cc5ef9ad41a
{
    ...
    public static function getLoader()
    {
        ...
        call_user_func(\Composer\Autoload\ComposerStaticInit7ec6d28e7a5b31abe58f7cc5ef9ad41a::getInitializer($loader));

        $loader->register(true);

        $filesToLoad = \Composer\Autoload\ComposerStaticInit7ec6d28e7a5b31abe58f7cc5ef9ad41a::$files;
